...
urlpatterns = [
    ...
    url(r'^login/main/encryptpage/$', views.encryptpage, name = 'encryptpage'),
    url(r'^login/main/testpage/$', views.testpage, name = 'testpage'),
    url(r'^login/main/decryptpage/$', views.decryptpage, name = 'decryptpage')
